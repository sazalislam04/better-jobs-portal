  ...
  return (
    <>
        ...
        {responsive ? (
          <>
            <div className={`top-0 -mb-8`}>
                ...
                <div className="flex sm:justify-center pt-3 items-center gap-x-2  w-full mx-auto overflow-x-scroll scroll-smooth">
                  {openClearBtn && counter !== 0 ? (
                    <div>
                      <button
                        ...
                        className={`text-[#037b8e] hover:shadow-md transition-all duration-300 my-2 w-20 px-2 py-2 text-sm rounded-lg custom-shadow  flex items-center gap-1 font-medium `}
                      >
                        Clear ({counter})
                      </button>
                    </div>
                    ...
                    <div className="flex text-sm text-gray-500 items-center">
                      <button className="border w-[120px] justify-between text-gray-600 hover:border-[#037b8e] hover:shadow-lg transition-all duration-300 my-2 px-3 py-2 text-sm rounded-lg custom-shadow flex items-center gap-1 ">
                        Filter jobs{" "}
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          fill="none"
                  ...
                  <div className="">
                    <button
                      ...
                      className={`border text-gray-600 hover:border-[#037b8e] hover:shadow-lg transition-all duration-300 my-2 px-4 py-2 text-sm rounded-lg custom-shadow flex items-center gap-2 ${
                        locationState !== "Location" &&
                  ...
                  <div className="">
                    <button
                      ...
                      className={`border text-gray-600 hover:border-[#037b8e] hover:shadow-lg transition-all duration-300 my-2 px-4 py-2 text-sm rounded-lg custom-shadow flex items-center gap-2 ${
                        experienceState === "Entry level" && "w-32"
                      } ${experienceState === "Mid-Senior level" && "w-40"} ${
                        experienceState !== "Experience" &&
                        "bg-yellow-50 hover:border-yellow-100"
                      }`}
                    >
              ...
              {/* single card */}
              <div className={`w-full sm:w-9/12 mx-auto px-3`}>
          ...
          <>
            <div className={`w-full`}>
              <div className="flex -mt-4 justify-between bg-green-50 h-28 items-center px-4">
                <button
                ...
                >
                  ...
                  all {jobrole ? jobrole : roleJob} jobs
                </button>
                <div>
                  ...
                  {/* tooltip */}
                  {open && (
                    <div className="mx-auto z-10 absolute md:-bottom-5 shadow border right-0 container h-36 py-3 bg-white rounded ">
                      <div className="flex mt-8">
                        <p className="text-lg mx-auto font-semibold leading-none text-gray-800">
                          Share this job
                        </p>
                      </div>
                      <div className=" text-xs mx-auto flex justify-center gap-6 mt-4 leading-none text-gray-600 pt-3 pb-2">
                        <Link
      ...
      <div className="hidden lg:block">
        ...
        >
          {/* jobs card details */}
          <div className="lg:w-3/5 lg:mt-[58px] bg-white shadow rounded-md pt-5">
            <>
              {job && (
                <JobsDetails
                  job={job}
      ...
      {applyJob && <ApplyModal setApplyJob={setApplyJob} applyJob={applyJob} />}
    </>
  );
};
